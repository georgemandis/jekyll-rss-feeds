...
Lastly, if you're a [Pinboard](https://pinboard.in) user and found this repo useful, take a loot at [jekyll-pinboard](https://github.com/snaptortoise/jekyll-pinboard-plugin). It allows you to load your Pinboard bookmarks into your Jekyll site with just a couple lines.
